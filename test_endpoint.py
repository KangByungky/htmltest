    ...
    "paragraphs": [
        {
            ...
            "token_delimiters": " \t\n\r\u000b\f",
            "tokens": [
                {"txt": "Les", "is_delimiter": False, "gloss": "The"},
                {"txt": " ", "is_delimiter": True, "gloss": None},
                {"txt": "champs", "is_delimiter": False, "gloss": "fields"}
            ]
        },
        {
            "is_delimiter": True,
            "token_delimiters": " \t\n\r\u000b\f",
            "tokens": [{"txt": "\n\n", "is_delimiter": True, "gloss": None}]
        },
        {
            "is_delimiter": False,
            "token_delimiters": " \t\n\r\u000b\f",
            "tokens": [{"txt": "n'étaient", "is_delimiter": False, "gloss": "!UNKNOWN"}]
        }
    ]
}
    ...
    "paragraphs": [
        {
            ...
            "token_delimiters": " \t\n\r\x0b\x0c",
            "tokens": [
                {"gloss": "0: ERROR:", "is_delimiter": False, "txt": "ERROR:"},
                {"gloss": None, "is_delimiter": True, "txt": " "},
                {"gloss": "!UNKNOWN", "is_delimiter": False, "txt": "METHOD"},
                {"gloss": None, "is_delimiter": True, "txt": " "},
                {"gloss": "!UNKNOWN", "is_delimiter": False, "txt": "IS"},
                {"gloss": None, "is_delimiter": True, "txt": " "},
                {"gloss": "!UNKNOWN", "is_delimiter": False, "txt": "\"GET\""},
                {"gloss": None, "is_delimiter": True, "txt": " "},
                {"gloss": "!UNKNOWN", "is_delimiter": False, "txt": "NOT"},
                {"gloss": None, "is_delimiter": True, "txt": " "},
                {"gloss": "!UNKNOWN", "is_delimiter": False, "txt": "\"POST\""}
            ]
        }
    ]
}
